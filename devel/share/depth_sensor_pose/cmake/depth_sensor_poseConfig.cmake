...
if("TRUE" STREQUAL "TRUE")
  set(depth_sensor_pose_SOURCE_PREFIX /home/student/RAT/Thirty-Gallon-Robot-part-2/src/depth_nav_tools/depth_sensor_pose)
  set(depth_sensor_pose_DEVEL_PREFIX /home/student/RAT/Thirty-Gallon-Robot-part-2/devel)
  ...
  set(depth_sensor_pose_INSTALL_PREFIX /home/student/RAT/Thirty-Gallon-Robot-part-2/install)
...
if(NOT "/home/student/RAT/Thirty-Gallon-Robot-part-2/devel/include;/home/student/RAT/Thirty-Gallon-Robot-part-2/src/depth_nav_tools/depth_sensor_pose/include " STREQUAL " ")
  set(depth_sensor_pose_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/RAT/Thirty-Gallon-Robot-part-2/devel/include;/home/student/RAT/Thirty-Gallon-Robot-part-2/src/depth_nav_tools/depth_sensor_pose/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_sensor_pose' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/RAT/Thirty-Gallon-Robot-part-2/src/depth_nav_tools/depth_sensor_pose/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT depth_sensor_pose_NUM_DUMMY_TARGETS)
      set(depth_sensor_pose_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::depth_sensor_pose::wrapped-linker-option${depth_sensor_pose_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR depth_sensor_pose_NUM_DUMMY_TARGETS "${depth_sensor_pose_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::depth_sensor_pose::wrapped-linker-option${depth_sensor_pose_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND depth_sensor_pose_LIBRARIES "${interface_target_name}")
