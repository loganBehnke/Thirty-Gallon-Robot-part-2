...
if("FALSE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/robot-workstation/mapping/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/robot-workstation/mapping/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/robot-workstation/mapping/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot-workstation/mapping/install/${idir}'.  ${_report}")
    endif()
